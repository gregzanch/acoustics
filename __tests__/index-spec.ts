...
test("Bands Has ThirdOctaveBands module", () => expect(AC.Bands.ThirdOctave).toBeTruthy());
test("Bands Has OctaveBands module", () => expect(AC.Bands.Octave).toBeTruthy());
...
test("Transmission Has TL module", () => expect(AC.Transmission.TL).toBeTruthy());
test("Transmission Has NR module", () => expect(AC.Transmission.NR).toBeTruthy());
test("Transmission Has tau module", () => expect(AC.Transmission.tau).toBeTruthy());
test("Transmission Has compositeTL module", () => expect(AC.Transmission.compositeTL).toBeTruthy());
